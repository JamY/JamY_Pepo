...
class Goods(models.Model):
    ...
    商品
    """
    category = models.ForeignKey(GoodsCategory, verbose_name="商品类目", on_delete=models.CASCADE) # 商品类目是必要的，默认null=False，如果为True，Django 将空值以NULL 存储到数据库中
    ...
    goods_desc = UEditorField(verbose_name=u"内容", imagePath="goods/images/", width=1000, height=300,
                              filePath="goods/files/", default='') #设置文本编辑框的高度，上传商品的图片的位置，文件的位置
...
class Banner(models.Model):
    ...
    def __str__(self):
        return self.goods.name
# 在django2.0后，定义外键和一对一关系的时候需要加on_delete
# 一般情况下使用CASCADE(级联删除)就可以了
